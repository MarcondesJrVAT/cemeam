                                ...
                                @foreach($users as $user)
                                    <tr class="dark:hover:bg-gray-600 hover:bg-gray-300">
                                        ...
                                        <td class="flex justify-end px-6 py-4 space-x-1 whitespace-normal text-sm font-medium">
                                            <a href="#" type="button" class="text-blue-500" title="Detalhes de {{ $user->name }}">
                                                <x-icons.eye aria-hidden="true" />
                                            </a>
                                            <a href="#" type="button" class="text-blue-500" title="Editar {{ $user->name }}">
                                                <x-icons.pencil-square aria-hidden="true" />
                                            </a>
                                            <button type="button" class="text-blue-500" title="Remover {{ $user->name }}" wire:click="confirmUserRemoval({{ $user->id }})">
